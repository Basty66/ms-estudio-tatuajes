          ...
          {categories.map((cat, i) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -8 }}
                className="group relative rounded-2xl overflow-hidden min-h-[220px] md:min-h-[520px] glass-card cursor-pointer"
              >
                <img
                  src={cat.image}
                  alt={cat.title}
                  loading="lazy"
                  className="absolute inset-0 w-full h-full object-contain md:object-cover bg-black transition-transform duration-700 group-hover:scale-105"
                />
